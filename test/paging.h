...
#define PAGING_PTE_DEFAULT_FLAGS (PAGING_PTE_PRESENT_FALSE | PAGING_PTE_CACHE_DISABLE | PAGING_PTE_LEVEL_USER)
#define PAGING_PDE_DEFAULT_FLAGS (PAGING_PDE_PRESENT_FALSE | PAGING_PDE_CACHE_DISABLE | PAGING_PDE_LEVEL_USER)
